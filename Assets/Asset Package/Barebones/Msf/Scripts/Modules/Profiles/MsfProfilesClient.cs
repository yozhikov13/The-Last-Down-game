...
namespace Barebones.MasterServer
{
    public class MsfProfilesClient : MsfBaseClient
    {
        ...
        public void GetProfileValues(ObservableProfile profile, SuccessCallback callback, IClientSocket connection)
        {
            ...
            connection.SendMessage((short)MsfMessageCodes.ClientProfileRequest, profile.PropertyCount, (status, response) =>
            {
                ...
                connection.SetHandler((short)MsfMessageCodes.UpdateClientProfile, message =>
                {
