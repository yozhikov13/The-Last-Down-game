...
namespace Barebones.MasterServer.Examples.BasicConnection
{
    public class BasicConnectionPlayerBuild
    {
        [MenuItem("Tools/MSF/Build/Demos/Basic Connection/All")]
        ...
        [MenuItem("Tools/MSF/Build/Demos/Basic Connection/Master Server")]
        private static void BuildMasterForWindows()
        {
            ...
            {
                scenes = new[] { "Assets/Barebones/Demos/BasicConnection/Scenes/MasterServer/MasterServer.unity" },
        ...
        [MenuItem("Tools/MSF/Build/Demos/Basic Connection/Client")]
        private static void BuildClientForWindows()
        {
            ...
            BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[] { "Assets/Barebones/Demos/BasicConnection/Scenes/Client/Client.unity" },
